...
CERAMIC_PUBLISH_JSON_TEMPLATE = {
    "query": """mutation CreateNounsProposal($proposal: CreateNounsProposalInput!) { createNounsProposal(input: $proposal) { document { blocknumber created_timestamp unique_holders total_supply proposal_id requested_eth start_block end_block total_votes total_distinct_voters quorum_required votes_for distinct_voters_for votes_against distinct_voters_against votes_abstain distinct_votes_abstain proposer transactionhash description state}}}""",
    "variables": {
         "proposal": {
            "content": {
              "blocknumber": 1,
...
CERAMIC_PUBLISH_JSON_TEMPLATE2 = {
    "query": """mutation CreateNounsProposal($proposal: CreateNounsProposalInput!) {
          createNounsProposal(input: $proposal) {
            document {
              blocknumber
