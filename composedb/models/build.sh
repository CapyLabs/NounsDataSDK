...
composedb composite:merge ./$TARGET_DIR/nounish_profile_composite.json ./$TARGET_DIR/nouns_proposal_composite.json --output=./$TARGET_DIR/merged_composites.json
...
composedb composite:compile ./$TARGET_DIR/merged_composites.json ./$TARGET_DIR/merged_runtime_composite.json
...
# Merging 
echo 'Merging composites'
touch ./$TARGET_DIR/merged_composites.json
